...
impl FireBullet {
  pub fn new(pos: Vector2<f32>, life_time: f32, friendly: bool) -> FireBullet {
    
    FireBullet {
      o_data: ObjectData::new(pos, Vector2::new(24.0, 24.0), "fire_bullet".to_string()),
  ...
  pub fn set_angle(mut self, angle: f32) -> FireBullet {
...
impl GenericObject for FireBullet {
...
impl GenericEntity for FireBullet {
