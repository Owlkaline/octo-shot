...
impl HeartEnemy {
  pub fn new(pos: Vector2<f32>) -> HeartEnemy {
    HeartEnemy {
      o_data: ObjectData::new(pos, Vector2::new(48.0, 48.0), "heart_enemy".to_string()),
...
impl GenericObject for HeartEnemy {
...
impl LootTable for HeartEnemy {
  ...
  fn drop_loot(&self, rng: &mut ThreadRng) -> Vec<Loot> {
    self.heart_enemy_loot(self.position(), rng)
  }
}

impl GenericEntity for HeartEnemy {
